...
import pandas as pd
import sys
sys.path.append('/N/project/st_brain/abudhkar/SiGra_test/SiGra_newmodel/ConGI')
...
# Add data read in class Dataset
# Add functions for metric computation and plot in ConGI get_predicted_results function.